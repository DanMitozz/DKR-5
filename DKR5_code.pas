...
begin
  ...
  readln(n2);
  Assign(in1text, 'D:\LR 14\DKR5textin.1.txt');
  Assign(in2text, 'D:\LR 14\DKR5textin.2.txt');
  Assign(out1text,'D:\LR 14\DKR5textout.1.txt');
  Assign(out2text,'D:\LR 14\DKR5textout.2.txt');
  rewrite(in1text);
  var a: char;
